      ...
      <div id="terms">
        <div>
          ...
          <p>
            ...
            <a href="terms/archive?hl=en&amp;gl=us">view archived versions</a>)
          </p>
          <h2>Welcome!</h2>
          <p>
            Thanks for using our products and services (“Services”). The
            Services are provided by LLC (“”), located at 1600 Amphitheatre
          ...
          <h2>
            <div id="toc-services" className="ahbJ5" />
            Using our Services
          </h2>
          <p>
          ...
          <p>
            Our Services display some content that is not ’s. This content is
            the sole responsibility of the entity that makes it available. We
            may review content to determine whether it is illegal or violates
            our policies, and we may remove or refuse to display content that we
            reasonably believe violates our policies or the law. But that does
          ...
          <h2>
            <div id="toc-account" className="ahbJ5" />
            Your Account
          </h2>
          <p>
            You may need a Account in order to use some of our Services. You may
            create your own Account, or your Account may be assigned to you by
            an administrator, such as your employer or educational institution.
            If you are using a Account assigned to you by an administrator,
            different or additional terms may apply and your administrator may
            be able to access or disable your account.
          </p>
          <p>
            ...
            or Account,{" "}
            <a href="https://support..com/accounts/bin/answer.py?hl=en&amp;answer=58585">
              follow these instructions
            </a>
            .
          </p>
          <h2>
            <div id="toc-protection" className="ahbJ5" />
            Privacy and Copyright Protection
          </h2>
          <p>
            ’s <a href="privacy?hl=en&amp;gl=us">privacy policies</a> explain
            how we treat your personal data and protect your privacy when you
            use our Services. By using our Services, you agree that can use such
          ...
          <p>
            ...
            about submitting notices and ’s policy about responding to notices{" "}
            <a href="https://support..com/bin/static.py?hl=en&amp;ts=1114905&amp;page=ts.cs">
              in our Help Center
            </a>
            .
          </p>
          <h2>
            <div id="toc-content" className="ahbJ5" />
          ...
          <p>
            ...
            through our Services, you give (and those we work with) a worldwide
            ...
            other changes we make so that your content works better with our
            Services), communicate, publish, publicly perform, publicly display
            and distribute such content. The rights you grant in this license
            are for the limited purpose of operating, promoting, and improving
            our Services, and to develop new ones. This license continues even
            if you stop using our Services (for example, for a business listing
            you have added to Maps). Some Services may offer you ways to access
            and remove content that has been provided to that Service. Also, in
            some of our Services, there are terms or settings that narrow the
            scope of our use of the content submitted in those Services. Make
          ...
          <p>
            ...
            detection. This analysis occurs as the content is sent, received,
            and when it is stored.
          </p>
          <p>
            If you have a Account, we may display your Profile name, Profile
            photo, and actions you take on or on third-party applications
            connected to your Account (such as +1’s, reviews you write and
            ...
            limit sharing or visibility settings in your Account. For example,
            you can choose your settings so your name and photo do not appear in
            an ad.
          </p>
          <p>
            You can find more information about how uses and stores content in
          ...
          <h2>
            <div id="toc-software" className="ahbJ5" />
          ...
          <p>
            ...
            non-exclusive license to use the software provided to you by as part
            of the Services. This license is for the sole purpose of enabling
            you to use and enjoy the benefit of the Services as provided by , in
            the manner permitted by these terms. You may not copy, modify,
          ...
          <h2>
            <div id="toc-modification" className="ahbJ5" />
          ...
          <p>
            ...
            to see you go. may also stop providing Services to you, or add or
          ...
          <h2>
            <div id="toc-warranties-disclaimers" className="ahbJ5" />
          ...
          <p>
            ...
            NEITHER NOR ITS SUPPLIERS OR DISTRIBUTORS MAKE ANY SPECIFIC PROMISES
          ...
          <h2>
            <div id="toc-liability" className="ahbJ5" />
            Liability for our Services
          </h2>
          <p>
            WHEN PERMITTED BY LAW, , AND ’S SUPPLIERS AND DISTRIBUTORS, WILL NOT
            BE RESPONSIBLE FOR LOST PROFITS, REVENUES, OR DATA, FINANCIAL LOSSES
            OR INDIRECT, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES.
          </p>
          <p>
            TO THE EXTENT PERMITTED BY LAW, THE TOTAL LIABILITY OF , AND ITS
          ...
          <p>
            IN ALL CASES, , AND ITS SUPPLIERS AND DISTRIBUTORS, WILL NOT BE
            LIABLE FOR ANY LOSS OR DAMAGE THAT IS NOT REASONABLY FORESEEABLE.
          </p>
          <h2>
            <div id="toc-business-uses" className="ahbJ5" />
            Business uses of our Services
          </h2>
          <p>
            If you are using our Services on behalf of a business, that business
            accepts these terms. It will hold harmless and indemnify and its
          ...
          <h2>
            <div id="toc-about" className="ahbJ5" />
            About these Terms
          </h2>
          <p>
          ...
          <p>
            These terms control the relationship between and you. They do not
          ...
          <p>
            ...
            you and consent to personal jurisdiction in those courts.
          </p>
          <p>
            For information about how to contact , please visit our{" "}
            <a href="https://www..com/contact/">contact page</a>.
          </p>
        </div>
        ''
      </div>
